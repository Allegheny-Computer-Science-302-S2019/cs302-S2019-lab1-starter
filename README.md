...
# cs302-S2019-lab1-solution

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the solution for Laboratory 2 in Computer Science 302.
...
- src/www/html/answers.md:
  ...
  - Contains exactly five uses of the `##` sectioning markers
  - Contains at least one use of the `github.css` name
  - Contains at least one use of the `tufte.css` name
...
you can go to the [Computer Science 302 Lab 1
